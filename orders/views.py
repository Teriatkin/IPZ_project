...
def checkout(request):
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            order = Order.objects.create(user=user, customer_name=name, customer_phone=phone, statuse_id=1)
            ...
            for name, value in data.items():
                if name.startswith("product_in_basket_"):
                    ...
                    Product_in_order.objects.create(product=product_in_basket.product,
